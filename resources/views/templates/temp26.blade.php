...
<body class="bg-white min-h-screen">
    <div class="cv-page max-w-[210mm] mx-auto bg-white shadow-lg min-h-[297mm] font-sans text-slate-800 px-14 py-12">
        ...
        @if (isset($coverLetter))
            <section class="mt-8">
                <h2 class="text-base font-bold text-slate-900 uppercase tracking-wide border-b-2 border-blue-600 pb-2">Ansøgning</h2>
        ...
        @if ($links->isNotEmpty())
            <section class="mt-10">
                <h2 class="text-base font-bold text-slate-900 uppercase tracking-wide border-b-2 border-blue-600 pb-2">Links</h2>
