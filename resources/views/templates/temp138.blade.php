...
<body class="bg-white min-h-screen">
    <div class="cv-page max-w-[210mm] mx-auto bg-white lined shadow-lg min-h-[297mm] font-sans text-slate-800 relative overflow-hidden">
        ...
        <div class="pl-28 pr-14 py-14">
            ...
            @if ($links->isNotEmpty())
                <section class="mt-9">
                    <h2 class="inline-block text-xs font-extrabold uppercase tracking-widest text-white bg-blue-700 px-4 py-2 rounded-r-md">Links</h2>
                    <ul class="mt-5 text-sm leading-9 text-slate-700">
