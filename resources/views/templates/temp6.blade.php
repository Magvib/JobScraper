        ...
        <div class="mt-10 grid flex-1 grid-cols-[1fr_55mm] gap-12">
            ...
            <main>
                @if (isset($coverLetter))
                    <h2 class="text-[10px] font-bold uppercase tracking-[0.4em] text-emerald-600 border-b border-stone-300 pb-2">Ansøgning</h2>
            ...
            @if ($skills || $links->isNotEmpty())
                <aside>
                    ...
                    @if ($links->isNotEmpty())
                        <h2 class="mt-8 text-[10px] font-bold uppercase tracking-[0.4em] text-emerald-600 border-b border-stone-300 pb-2">Links</h2>
                        <ul class="mt-6 space-y-2 text-sm">
                            @foreach ($links as $link)
                                <li>
                                    <p class="font-bold text-gray-900">{{ $link->name }}</p>
