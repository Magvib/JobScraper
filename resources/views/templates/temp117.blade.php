...
<body class="bg-white min-h-screen">
    <div class="cv-page relative max-w-[210mm] mx-auto bg-white ruled shadow-md min-h-[297mm] font-sans text-slate-800 overflow-hidden">
        ...
        <div class="px-25 pt-12 pb-14">
            ...
            @if ($links->isNotEmpty())
                <section class="mt-10">
                    <h2 class="inline-block text-xs font-extrabold uppercase tracking-widest text-white bg-red-500 px-3 py-1.5 -ml-3 shadow-sm">Links</h2>
                    <ul class="mt-5 text-sm leading-8 text-slate-700">
