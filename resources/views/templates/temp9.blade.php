...
<body class="bg-white min-h-screen">
    <div class="cv-page max-w-[210mm] mx-auto bg-orange-50 shadow-lg overflow-hidden grid grid-cols-[70mm_1fr] min-h-[297mm] font-sans text-gray-900">
        ...
        <main class="bg-white px-10 py-12">
            ...
            @if ($links->isNotEmpty())
                <section class="mt-8">
                    <h2 class="text-xs font-bold uppercase tracking-[0.25em] text-orange-500 border-b-2 border-orange-100 pb-2">Links</h2>
                    <ul class="mt-4 space-y-2 text-sm">
                        @foreach ($links as $link)
                            <li>
                                <span class="font-semibold text-orange-700">{{ $link->name }}</span>
            ...
            @if (isset($coverLetter))
                <section class="mt-8">
                    <h2 class="text-xs font-bold uppercase tracking-[0.25em] text-orange-500 border-b-2 border-orange-100 pb-2">Ansøgning</h2>
