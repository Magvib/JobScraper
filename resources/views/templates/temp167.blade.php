...
<body class="bg-white min-h-screen">
    <div class="cv-page max-w-[210mm] mx-auto bg-[#1c1917] text-stone-100 shadow-xl min-h-[297mm] font-sans overflow-hidden">
        ...
        <div class="bg-[#f5f0e6] text-stone-900 mx-0 px-14 py-10 min-h-[170mm]">
            ...
            @if ($links->isNotEmpty())
                <section class="mt-8">
                    <h2 class="text-xs font-black uppercase tracking-[0.35em] text-amber-700 border-b-2 border-stone-900 pb-2">Links · Forespørgsler</h2>
                    <ul class="mt-3 space-y-1.5 text-[14px] text-stone-600">
