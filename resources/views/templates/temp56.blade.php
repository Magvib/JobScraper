...
<body class="bg-white min-h-screen">
    <div class="cv-page max-w-[210mm] mx-auto bg-[#f7f9f4] shadow-lg min-h-[297mm] font-sans text-green-950 px-12 py-12">
        ...
        <div class="mt-9">
            ...
            @if ($links->isNotEmpty())
                <section class="mt-8">
                    <h2 class="text-sm font-extrabold uppercase tracking-widest text-green-800 px-2">Links</h2>
                    <ul class="mt-4 space-y-2 text-sm">
                        @foreach ($links as $link)
                            <li class="flex flex-wrap items-baseline gap-x-2 px-2">
                                <span class="font-semibold text-green-900">{{ $link->name }}</span>
